...
local audioEvent_skidLF = ac.AudioEvent("/cars/ohyeah2389_modkart_class2/skid_custom", true, true)
local audioEvent_skidRF = ac.AudioEvent("/cars/ohyeah2389_modkart_class2/skid_custom", true, true)
local audioEvent_skidLR = ac.AudioEvent("/cars/ohyeah2389_modkart_class2/skid_custom", true, true)
local audioEvent_skidRR = ac.AudioEvent("/cars/ohyeah2389_modkart_class2/skid_custom", true, true)
...
function script.update()
    ...
    for tireIndex, event in ipairs({audioEvent_skidLF, audioEvent_skidRF, audioEvent_skidLR, audioEvent_skidRR}) do
        ...
        local baseVolume = helpers.mapRange(car.wheels[tireIndex - 1].ndSlip, 0.01, 1.6, 0, 1, true)
